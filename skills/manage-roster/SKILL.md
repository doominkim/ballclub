---
name: manage-roster
description: Inspect or repair Ballclub's managed Codex or Claude Code roster when automatic SessionStart synchronization reports conflicts, security drift, degraded setup, missing profiles, or stale profiles, or when the user explicitly asks to customize or reset player models. Do not use for a healthy automatic startup.
---
